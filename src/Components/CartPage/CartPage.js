...
const CartPage = () => {
  // State and product data for cart items
  ...
  // calculating the total for the product price, quantity, substracting discount, promo code discount.
  useEffect(() => {
    ...
    // substracting 20% fixed discount and promo code discount.
    const discount = subtotal * 0.2;
    const total =
      subtotal - discount - orderSummary.promoDiscount + orderSummary.shipping;
  ...
  // promocode , this SAVE10 will deduct 10% of total price.
  const applyPromoCode = () => {
    if (promoCode === "SAVE10") {
      setOrderSummary({
        ...orderSummary,
        promoDiscount: orderSummary.subtotal * 0.1,
      });
        ...
        <div className="order-summary-div">
          <div className="order-summary">
            ...
            <div className="summary-item">
              ...
              <span className="discount summary-item-span">
